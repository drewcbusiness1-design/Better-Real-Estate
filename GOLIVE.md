...
Profile → Admin — suppliers. Register a supplier, paste a JSON catalog, markup and categories are applied automatically. Sales land in Profile → Admin — fulfilment queue with the customer's address, your cost and your profit. Place the order with the supplier, paste tracking back in.
