...
for(const t of ['TUTORIAL_VERSION = 28','tutorialTier()','tutorialStepsFor','tutorialCompletedKeys','tutorialHighestRank','NEW FEATURE TOUR','Skip this step','Skip entire tour','tour-focus-ring','Showing ${tier','dealbuildersearch','buyercrmpage','workspacepage']) assert(app.includes(t),t);
...
assert(/\[data-theme="dark"\] \.guided-tour-card/.test(css),'tutorial card must be opaque in dark mode');
