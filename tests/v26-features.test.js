...
for(const token of ['renderDealBuilder','Smart Comps Workspace','Deal Analyzer','renderBuyerCRM','TUTORIAL_VERSION = 26','Skip tutorial','Skip this step','Restart platform tutorial']) assert(app.includes(token),token);
